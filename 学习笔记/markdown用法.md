...
-   **Markdown** **书写软件** 推荐：**Typora** 优秀的 MD网页文章 书写软件
    -   [点击跳转下载地址 182](https://www.typora.io/ "Typora编辑器")
-   **Markdown** **笔记软件** 推荐：**Obsidian** **银河系最强** **MD+ 双向链** 笔记软件
    -   [点击跳转下载地址 228](https://obsidian.md/ "银河系第一笔记软件 Obsidian")
...
![引用退格1](/学习笔记/网络图片下载/引用退格1.gif)

![引用退格2](/学习笔记/网络图片下载/引用退格2.gif)
...
-   **补充：**
    ...
    -   图像链接可以是**本地**的，也可以是**在线**的
        ...
        -   在线图像推荐使用 [图床 165](https://imgtu.com/ "这是一个在线图床网址")
...
[百度一下，你就知道 238](http://www.baidu.com/)

[知乎-有问题，就会有答案 15](https://www.zhihu.com/)
...
-   **多彩加粗文本：**
    ...
    -   只需要在上面示例的基础上，为里面的文本内容加上 **加粗标识符**
        ...
        -   **格式：** `<font color=teal>**这是一段加粗的水鸭色文本**</font>`
            -   color 里的颜色支持 英文单词，**[16进制 16](http://c.runoob.com/front-end/55 "可跳转至菜鸟教程了解")，[rgb 9](https://www.runoob.com/cssref/func-rgb-css.html "可跳转至菜鸟教程了解")，[rgba 6](https://www.runoob.com/cssref/func-rgba.html "可跳转至菜鸟教程了解")**
...
-   用一对 : 包裹，里面是 **Emoji** 符号的 **语义化文本** ( **Typora编辑器** 中，输入 `:` 就会带提示器 )
    ...
    -   **效果：**
        ...
        -   ![:smile:](/学习笔记/网络图片下载/smile.png)  
            ![:sweat:](/学习笔记/网络图片下载/sweat.png)
            
            ![:cat:](/学习笔记/网络图片下载/cat.png)  
            ![:woman_cartwheeling:](/学习笔记/网络图片下载/woman_cartwheeling.png)
...
-   在显示文本内容中，在其中一个中括号前面，加上**转义符号** 反斜杠 **\\**
    ...
    -   **效果：** [链接里的 \[中括号\] 能被正常显示 4](https://www.runoob.com/)
...
![latex 行内公式](/学习笔记/网络图片下载/latex_行内公式.png)
...
-   **补充：**
    -   需要详细教程的，可戳下方链接
    -   [Latex详细教程 137](https://www.wolai.com/wolai/egjDbHiAfGfJmwR972fcEW "wolai Latex教程")

## [](https://forum-zh.obsidian.md/t/topic/435#17-mermaid-86)17\. Mermaid

-   一些 **MD编辑器** 和 **笔记软件** 支持通过 [**Mermaid** 12](https://mermaid-js.github.io/ "Mermaid官网") 及其所提供的 [编译器 4](https://mermaid-js.github.io/mermaid-live-editor "Mermaid在线编译器") 来为用户提供图表的绘制功能
    
-   这里只提供一些演示的图表，具体教程可戳下方链接
    
    -   [Mermaid详细教程 137](https://zhuanlan.zhihu.com/p/355997933 "知乎Mermaid教程")
...
[![mermaid 流程图](/学习笔记/网络图片下载/mermaid_流程图.png)](https://forum-zh.obsidian.md/uploads/default/original/1X/1d45d0418552fc61e2791604f981c69761cfa6b0.png "mermaid 流程图")
...
[![mermaid 饼图](/学习笔记/网络图片下载/mermaid_饼图.png)](https://forum-zh.obsidian.md/uploads/default/original/1X/c0bb1ec053714409c4dcd5b68426be4cae47f1be.png "mermaid 饼图")
...
[![mermaid 时序图](/学习笔记/网络图片下载/mermaid_时序图.png)](https://forum-zh.obsidian.md/uploads/default/original/1X/5a9de2149386fa6b665119d4eb2365cc629809bf.png "mermaid 时序图")
...
[![mermaid 甘特图](/学习笔记/网络图片下载/mermaid_甘特图.png)](https://forum-zh.obsidian.md/uploads/default/original/1X/055649b00d70ed0fb49752c7192a67f23b049211.png "mermaid 甘特图")